...
#######################################
#	CMSIS
C_INCLUDES +=	-Ithirdparty/CMSIS/Device/ST/STM32F0xx/Include\
				-Ithirdparty/CMSIS/Include

#######################################
#	HAL drivers
C_INCLUDES +=	-Ithirdparty/STM32F0xx_HAL_Driver/Inc\
